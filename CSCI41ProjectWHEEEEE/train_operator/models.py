...
class TRAIN_MODEL(models.Model):
    ...
    No._of_Seats = models.PositiveIntegerField(primary_key=False, default=0, validators=[MinValueValidator(0), MaxValueValidator(999)])
    No._of_Toilets = models.PositiveIntegerField(primary_key=False, default=0, validators=[MinValueValidator(0), MaxValueValidator(99)])
